    ...
    <>
      ...
      <div className="video-header">
        ...
        <div className="padding_1200">
          ...
          <div className="header-button">
            <a href="/gallery.html" id="gallery-button">
      ...
      <div className="padding_1200">
        <div className="main-page_about">
          <div className="text_date-of-creation">
            <a>радуем заказчиков с 2015 года</a>
          </div>
          <div className="materials">
            <div className="image-blocks-materials">
              <div className="material material-titan titan">
                <img src="/src/content/titan.png" alt="titan" id="titan" />
                <div
              ...
              <div className="material material-steel steel">
                ...
                <div className="img-blocks-steel">
                  <img
                    src="/src/content/chain.png"
                    alt="steel-img-1"
                    id="steel-img-1"
                  />
                  <img
                    src="/src/content/steel.jpg"
                    alt="steel-img-2"
                    id="steel-img-2"
                  />
                </div>
              ...
              <div className="material material-metal metal">
                ...
                <div className="metal-img">
                  <img
                    src="/src/content/pruti-stalniye.jpg"
                    alt="metal"
                    id="metal"
                    className="abs-box"
                  />
          ...
          <div className="about-and-plastic plastic">
            ...
            <div className="material-plastic plastic">
              <div className="abs-box plastic-img">
                <img src="" alt="plastic" id="plastic" />
              </div>
      ...
      <div className="order">
        <div className="background-images">
          <img src="" alt="" id="order-bg-img-1" />
          <img src="" alt="" id="order-bg-img-2" />
          <img src="" alt="" id="order-bg-img-3" />
        </div>
        <div className="padding_1200">
